...
По нажатию кнопки открывается текст темы.
Если текст, фото или ссылки темы меняли меньше двух дней назад, на карточке
и на кнопке появляется значок 🆕. Через двое суток он пропадает сам.
...
8. Баннеры-карточки из `banners/` этим не меняются.
